...
pimcore.plugin.LemonmindMessageBundle = Class.create({

    initialize: function () {
        document.addEventListener(pimcore.events.postOpenObject, this.message.bind(this));
    },
    ...
    message: async function (e) {
        ...
        const objectClass = e.detail.object.data.general.className;
...
var LemonmindMessageBundle = new pimcore.plugin.LemonmindMessageBundle();